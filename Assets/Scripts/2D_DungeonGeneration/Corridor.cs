...
public class Corridor
{
	...
	public void SetupCorridor (Room room, IntRange length, int width, IntRange roomWidth, IntRange roomHeight, int columns, int rows, bool firstCorridor)
	{
		...
		case Direction.North:
			...
			startXPos = Random.Range (room.xPos + halfWidth, room.xPos + room.roomWidth - halfWidth);
		...
		case Direction.East:
			...
			startYPos = Random.Range(room.yPos + halfWidth, room.yPos + room.roomHeight - halfWidth);
